          ...
          @endif
              ...
              <div class="member mt-3">
                ...
                <form class="form-inline" method="post" action="{{ route('checkout-create', $item->id) }}">
                  ...
                  <input type="text" name="nationality" class="form-control mb-2 mr-sm-2" id="nationality" style="width: 50px" required placeholder="Nationality" />
                  ...
                  <div class="input-group mb-2 mr-sm-2">
                    <input type="text" class="form-control datepicker" style="width: 130px" name="doe_passport" id="doe_passport" placeholder="DOE Passport" />
                  </div>
